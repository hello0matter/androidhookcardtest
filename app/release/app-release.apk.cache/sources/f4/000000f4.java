...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView {
    ...
    public static final int[] f483d = {16843126};

    /* renamed from: a  reason: collision with root package name */
    public final w f484a;

    /* renamed from: b  reason: collision with root package name */
    public final y0 f485b;
    ...
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        ...
        return this.f486c.f(onCreateInputConnection, editorInfo);
    }
    ...
    public void setEmojiCompatEnabled(boolean z4) {
        ((s0.b) this.f486c.f726c).f6498a.r(z4);
    }

    @Override // android.widget.TextView
    public void setKeyListener(@Nullable KeyListener keyListener) {
        super.setKeyListener(this.f486c.a(keyListener));
    }
    ...
    public AppCompatAutoCompleteTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i4) {
        ...
        q3 f4 = q3.f(getContext(), attributeSet, f483d, i4, 0);
