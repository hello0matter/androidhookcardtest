...
@kotlin.annotation.Target(allowedTargets = {AnnotationTarget.f5164a, AnnotationTarget.f5172i, AnnotationTarget.f5167d, AnnotationTarget.f5171h, AnnotationTarget.f5178o})
...
public @interface RequireKotlin {
    ...
    @Target({ElementType.TYPE, ElementType.METHOD, ElementType.CONSTRUCTOR})
    @Metadata(k = VisibleForTesting.PACKAGE_PRIVATE, mv = {1, 9, 0}, xi = 48)
    @kotlin.annotation.Target(allowedTargets = {AnnotationTarget.f5164a, AnnotationTarget.f5172i, AnnotationTarget.f5167d, AnnotationTarget.f5171h, AnnotationTarget.f5178o})
    @Retention(RetentionPolicy.SOURCE)
    @kotlin.annotation.Retention(AnnotationRetention.f5160a)
    @RepeatableContainer
    ...
    DeprecationLevel level() default DeprecationLevel.f5148b;

    String message() default "";

    String version();

    RequireKotlinVersionKind versionKind() default RequireKotlinVersionKind.f5186a;
}